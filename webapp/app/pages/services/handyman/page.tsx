...
export default function HandymanServices() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-cyan-700 to-cyan-600">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-cyan-50 max-w-3xl">
            With over 18 years of experience, TGA Builders Inc. provides comprehensive handyman services 
            ...
            <div className="bg-white shadow-sm rounded-lg p-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-cyan-600 flex-shrink-0 mt-1" />
                  <div>
