      ...
      <div className="bg-gradient-to-r from-cyan-700 to-cyan-600 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mt-4 text-lg text-cyan-50 max-w-3xl">
            Transform your bathroom into a luxurious and functional space. Our expert team 
            delivers high-quality bathroom renovation and installation services.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-semibold text-gray-900">Comprehensive Bathroom Services</h2>
            <p className="text-gray-600">
              From complete bathroom remodels to fixture installations, we provide a full range 
              of bathroom services. Our experienced team ensures quality workmanship and attention 
          ...
          <div className="bg-white shadow-sm rounded-lg p-6 lg:mt-0 mt-8">
            ...
            <p className="text-gray-600 mb-6">
              Ready to upgrade your bathroom? Contact us for a free consultation and estimate. 
              Our team is ready to help you create your dream bathroom.
            </p>
